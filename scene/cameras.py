...
class Camera(nn.Module):
    def __init__(self, colmap_id, pose_id, R, T, K, FoVx, FoVy, image, gt_alpha_mask,
                 image_name, uid, image_path=None, view_id=None, 
        ...
        if torch.isnan(self.original_image).any():
            print('NAN value in render results!!')
            assert False
        ...
        # print(self.full_proj_transform.shape)
        # assert False
